...
- 当前 127 项自动化测试覆盖单元、Workflow、持久化、CLI、观测、质量门禁、限流和端到端闭环；
...
2. 将共享 Provider 限流扩展到 Token/并发配额和动态供应商响应；
3. 增加按任务、Provider 与时间范围的成本报表和供应商账单对账接口；
4. 将当前手工阈值沉淀为经过真实运行校准的版本化基线策略；
